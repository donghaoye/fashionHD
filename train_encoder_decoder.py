...
from models.encoder_decoder_framework import EncoderDecoderFramework
from data.data_loader import CreateDataLoader
from options.encoder_decoder_options import TrainEncoderDecoderOptions
...
opt = TrainEncoderDecoderOptions().parse()

# create model
model = EncoderDecoderFramework()

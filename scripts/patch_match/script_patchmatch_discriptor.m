...
test_id = sprintf('%s_inhomoseg_pw15_pyr', src_2);
% patchmatch setting
...
use_image_pyramid = true; % use [0.75, 1, 1.25] image pyramid of img_1
...
if seg_guided
    desc_1 = expand_descriptor_by_seg(desc_1, desc_seg.desc_1, -10);
    desc_2 = expand_descriptor_by_seg(desc_2, desc_seg.desc_2, -10);
end
